...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-nova-icon-select', __webpack_require__(3));
  Vue.component('detail-nova-icon-select', __webpack_require__(6));
  Vue.component('form-nova-icon-select', __webpack_require__(9));
  Vue.component('option-nova-icon-select', __webpack_require__(22));
});
...
var render = function() {
  ...
  return _c("option-nova-icon-select", { attrs: { field: _vm.field } })
}
var staticRenderFns = []
  ...
  return _c(
    ...
    [
      _c(
        "template",
        { slot: "value" },
        [_c("option-nova-icon-select", { attrs: { field: _vm.field } })],
        1
      )
    ],
    2
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    ...
    filteredOptions: function filteredOptions() {
      ...
      return search ? this.field.options.filter(function (option) {
        return option.search && Array.isArray(option.search) && _this2.searchStringInArray(search, option.search) || option.label.toLowerCase().indexOf(search) > -1;
      }) : this.field.options;
    },
                ...
                [
                  _vm.selectedOption
                    ? _c(
                        ...
                        [
                          _c("option-nova-icon-select", {
                            attrs: { option: _vm.selectedOption }
                          })
                        ],
                        1
                      )
...
Component.options.__file = "resources/js/components/ShowOption.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-3c84d17d", Component.options)
  } else {
    hotAPI.reload("data-v-3c84d17d", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    item: function item() {
      ...
      return this.option || this.field.options.find(function (option) {
...
var render = function() {
  ...
  return _c("div", [
    _vm.item.icon
      ? _c("span", { staticClass: "w-6 mr-2" }, [
          _c("i", { class: _vm.item.icon })
        ])
      : _vm._e(),
    _vm._v(" "),
    _c("span", { domProps: { innerHTML: _vm._s(_vm.item.label) } })
  ])
}
var staticRenderFns = []
render._withStripped = true
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-3c84d17d", module.exports)
  }
}
